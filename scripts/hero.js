/**
 * Плавний скрол до секцій по кліку на кнопки-якорі (#anchor).
 * Якщо JS вимкнено — працює стандартний перехід за посиланням.
 */
...
function bindArchiveButton() {
  ...
  btn.addEventListener('click', () => {
    alert('Тут буде відкриватися ваш архів (PDF/список записів).');
  });
}
